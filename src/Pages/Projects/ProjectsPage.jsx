  ...
  const projects = [
    {
      ...
      all households. It helps users to  keep track of the items they have purchased, by scanning your barcodes of their
      items adding them to their virtual pantry. Pantry app allows users to know what they have to make your next grocery shopping a breeze.
       With easier management of their pantry through the app more households will be able to cut down on their environmental impact.`,
      tech: [
        "Redux",
        "Heroku",
        "Nodejs",
    ...
    },
    {
      ...
      img_url: SDM,
      tech: ["HTML", "JavaScript", "CSS", "Materialize"],
      live: `https://vonbarown.github.io/Student-Data-Management/`,
